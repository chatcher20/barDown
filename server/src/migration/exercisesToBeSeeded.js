const exercisesToBeSeeded = [
  {
    name: "Swedish 5-Pass & Shot Drill",
    description:
      "A classic passing drill where players pass the puch five times before taking a shot on the goalie in practise.",
    video_url: "https://www.youtube.com/watch?v=0hyYjZ6FXyQ",
  },
  {
    name: "Breakout: Crossing through Lanes",
    description:
      "A breakout drill that simualtes a game-situation when breaking out of one's zone. Players 'criss-cross' to create 'lanes' and an available target to pass to when exiting the zone.",
    video_url: "https://www.youtube.com/watch?v=5O4gkXT3UrE&list=PLAA1B7F192B173834&index=3",
  },
  {
